        ...
        <div className="signin-signup">
          ...
          <form onSubmit={loginHandler} className="sign-in-form">
            ...
            <div className="form-check">
              <input className="form-check-input" type="checkbox"  id="showPassword" checked={showPassword}
            ...
            <button type='submit'
           className="btn solid">LOGIN</button>
          </form>
          {/* SignUp */}
          <form onSubmit={signInHandler} className="sign-up-form">
            ...
            <div className="input-field">
              ...
              placeholder="Name" />
              {signInErrors.name && <div className="invalid-feedback d-block">{signInErrors.name}</div>}
            </div>
            <div className="input-field">
              <i className="fas fa-envelope"></i>
              <input type="text" 
              ...
              required
              placeholder="Email" />
              {signInErrors.email && <div className="invalid-feedback d-block">{signInErrors.email}</div>}
            </div>
            <div className="input-field">
              <i className="fas fa-lock"></i>
              <input 
                    ...
                    name="password"
                        ...
                        required
                    />
                    {signInErrors.password && <div className="invalid-feedback d-block">{signInErrors.password}</div>}
            ...
            <div className="input-field">
              ...
              <input 
                    ...
                    name="confirmPassword"
                        className={`form-control ${signInErrors.confirmPassword ? 'is-invalid' : ''}`}
                        id="confirmPassword"
                        onChange={sinputHandlerSignIn}
                        required
                     />
                     {signInErrors.confirmPassword && (
                        <div className="invalid-feedback d-block">{signInErrors.confirmPassword}</div>
                      )}
            </div>
            <div className="form-check">
      ...
      <div className="panels-container">
        <div className="panel left-panel">
          <div className="content">
            <h3>New here ?</h3>
            <p>
              Faculties who hasn't created an accout, please signup
            </p>
